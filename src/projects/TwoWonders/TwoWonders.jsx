      ...
      <main className="tw-main">
        ...
        <section className="tw-contributions">
          ...
          <article className="tw-contribution">
            ...
            <a className="tw-github-btn" href="https://github.com/Josemaik/TwoWonders/blob/main/src/managers/entity_manager.hpp" target="_blank" aria-label="View code on GitHub">
              <FaGithub />
              <span>EntityManager</span>
            </a>
            <a className="tw-github-btn" href="https://github.com/Josemaik/TwoWonders/blob/main/src/managers/entity_manager.hpp" target="_blank" aria-label="View code on GitHub">
              <FaGithub />
              <span>SlotMap</span>
            </a>
            <a className="tw-github-btn" href="https://github.com/Josemaik/TwoWonders/blob/main/src/utils/meta_program.hpp" target="_blank" aria-label="View code on GitHub">
              <FaGithub />
